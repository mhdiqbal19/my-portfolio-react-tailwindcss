        ...
        <div className="container">
            <div className="flex flex-wrap">
                <div className="w-full px-4 mb-10 lg:w-1/2">
                    ...
                    <p className='font-medium text-base text-secondary max-w-xl lg:text-lg'>I'am a Junior Frontend Engineer with strong passion to learn new things. I am familiar with a JavaScript programming, and I have developed application system using ReactJS. Currently I am interested and learning about React Native. I enjoy reading and running on my spare time.</p>
                </div>
                <div className="w-full px-4 lg:w-1/2">
                    <h3 className='font-semibold text-dark text-2xl mb-4 lg:text-3xl lg:pt-10'>I'am here</h3>
