        ...
        <div className="container">
            <div className="flex flex-wrap">
                <div className="w-full self-center px-4 lg:w-1/2 ">
                    <h1 className='text-base font-semibold text-primary md:text-xl lg:text-2xl'>IT Software Solutions<span className='block font-semibold text-dark text-4xl mt-1'>bariqi.tech</span></h1>
                    <h2 className='font-medium text-secondary mb-5 text-lg mt-3'>Jasa Penyedia Layanan Pembuatan Sistem Perkantoran, Aplikasi Website, Mobile dan GIS..</h2>
                    <p className='font-small text-secondary mb-10 leading-relaxed'>With us make your dream <span className='text-dark font-bold'> Technology </span>come true </p>
                ...
                <div className='w-full self-end px-4 lg:w-1/2'>
                  <div className='mt-10 relative lg:mt-9 lg:right-0'>
                    <img src='http://meridian.info/images/top_banner/banner%201.gif' alt="iqbal" className='max-w-full mx-auto'/>
